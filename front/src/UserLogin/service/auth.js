...
export const getAward = async (formData) => {
  const response =  await axios.post("http://localhost:5000/api/getAward", 
  formData);
...
export const getEdulevel = async (formData) => {
  const response =  await axios.post("http://localhost:5000/api/getEdulevel", 
  formData);
  console.log(response.data)
...
export const getCertificate = async (formData) => {
  const response =  await axios.post("http://localhost:5000/api/getCertificate", 
  formData);
...
export const getProject = async (formData) => {
  const response =  await axios.post("http://localhost:5000/api/getProject", 
  formData);
